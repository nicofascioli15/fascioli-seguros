      ...
      <div className="pago-modal" style={{ width: 600, maxHeight: '90vh', overflowY: 'auto' }} onClick={e => e.stopPropagation()}>
        ...
        {paso === 'edificio' ? (
          ...
          <>
            ...
            <ObraForm modo={obra ? 'editar' : 'nueva'} form={form} setForm={setForm} edificios={edificios} edificioLocked={obra ? null : elegido} empresas={empresas} onEmpresaCreada={n => setEmpresas(e => [...e, n].sort((x, y) => x.localeCompare(y)))} />
