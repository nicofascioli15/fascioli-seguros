...
type Tabla  = 'clientes' | 'polizas' | 'pagos' | 'siniestros' | 'documentos' | 'poliza_controles_mensuales' | 'mant_clientes' | 'mant_extintores' | 'mant_tanques' | 'mant_documentos' | 'mant_reclamos' | 'mant_empresas' | 'contratos' | 'contratos_empresas' | 'contratos_documentos'
