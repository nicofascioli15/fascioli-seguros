#!/bin/bash
set -e
mkdir -p 'app/(app)/polizas' 'app/(app)/clientes' components
      ...
      <div>
        ...
        <div style={{ background: 'var(--bg-card)', borderRadius: 12, border: '1px solid var(--border-soft)', padding: '18px 20px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 }}>
            ...
            <button className="btn-outline btn-sm" onClick={() => fileRef.current?.click()} disabled={uploadingDoc}>
        ...
        <div className="pago-overlay open" onClick={e => { if (e.target === e.currentTarget) { setShowUploadModal(false); setUploadFile(null) } }}>
          <div className="pago-modal" style={{ width: 440 }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8, marginTop: 20, paddingTop: 16, borderTop: '1px solid var(--border)' }}>
              ...
              <button className="btn-primary" onClick={confirmarSubidaDetalle}>
...
git add .
git commit -m 'fix feriados en polizas drag and drop csv'
git push
