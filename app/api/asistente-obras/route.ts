...
- Al terminar la obra hay 30 días corridos para comunicar el cierre de obra en BPS (antes formulario F9; hoy en línea, el F9 queda para obras de más de 5 años). Quién hace el cierre es un dato de cada obra (por contrato suele hacerlo la empresa aunque la obra esté a nombre del edificio); usá el campo lo_hace. Una obra sin cerrar puede trabar certificados en futuras ventas de unidades.
- Una obra está ABIERTA desde que se crea y se CIERRA sola cuando tiene todas las cuotas pagas y el F9 (cierre BPS). No hay otros estados.
