...
function ClientesList({ onSelect }: { onSelect: (c: Cliente) => void }) {
  ...
  async function confirmarEliminar() {
    ...
    await registrarAudit({ accion: 'eliminar', tabla: 'mant_clientes', registroId: confirmEliminar.id, descripcion: `Edificio eliminado: ${confirmEliminar.nombre}, junto con sus registros de mantenimiento y contratos` })
    setEliminando(false)
