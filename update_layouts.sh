#!/bin/bash
set -e
cat > app/usuarios/layout.tsx << 'FILEEOF'
...
FILEEOF
echo '+ app/usuarios/layout.tsx'

cat > app/historial/layout.tsx << 'FILEEOF'
import Sidebar from '@/components/Sidebar'
...
echo '   git add .'
echo '   git commit -m "fix: sidebar en usuarios e historial"'
echo '   git push'
