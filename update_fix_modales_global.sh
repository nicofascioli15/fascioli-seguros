...
@media (max-width: 768px) {
  ...
  /* ── MODALS ── */
  .pago-overlay { align-items: flex-end !important; padding: 0 12px 76px !important; }
  .pago-modal {
...
git add .
git commit -m 'fix critico modales mobile en toda la app respetan bottom nav y altura'
git push
