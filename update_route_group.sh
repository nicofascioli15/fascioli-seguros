#!/bin/bash
set -e
echo 'Reestructurando layout para sidebar sin saltos...'
...
cat > 'app/(app)/dashboard/historial/page.tsx' << 'FILEEOF'
'use client'
import { useState, useEffect } from 'react'
...
FILEEOF
echo '+ app/(app)/dashboard/historial/page.tsx'
...
cat > 'app/(app)/dashboard/usuarios/page.tsx' << 'FILEEOF'
'use client'
import { useState, useEffect } from 'react'
...
FILEEOF
echo '+ app/(app)/dashboard/usuarios/page.tsx'
...
echo 'Listo:'
echo '   git add .'
echo '   git commit -m "fix: route group unico layout sidebar sin saltos"'
echo '   git push'
